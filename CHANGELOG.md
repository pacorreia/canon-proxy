...
* allow release-please PR merges through the check-commit gate ([46847a1](https://github.com/pacorreia/canon-proxy/commit/46847a1584ec063cb88c8e5847132ecdf334e1e8))
...
* handle forced dispatch when release already exists in release-please workflow ([f55d90d](https://github.com/pacorreia/canon-proxy/commit/f55d90d78b0c87fdc4bcd9a7d6ee4987087b3045))
* log warning when forced release-please step fails in dispatch path ([7d7e39b](https://github.com/pacorreia/canon-proxy/commit/7d7e39b1519a1de230c7189e23574495ab04b72b))
...
* release workflow no longer fails when re-running forced dispatch for an existing release ([f07a209](https://github.com/pacorreia/canon-proxy/commit/f07a20962413bfb49ef10b6522a0d837c67a4bd5))
* release-please PR merge bypasses check-commit gate, skipping all publish jobs ([bdfa83d](https://github.com/pacorreia/canon-proxy/commit/bdfa83d729699f0054c0ae01d81834cc2bb4627c))
